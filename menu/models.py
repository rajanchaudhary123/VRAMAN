...
class PackageGallery(models.Model):
    package = models.ForeignKey(PackageItem,default=None,on_delete=models.CASCADE)
    image = models.ImageField(upload_to='menu/packages', max_length=500)
    ...
    class Meta:
        ...
        verbose_name_plural = 'package gallery'
